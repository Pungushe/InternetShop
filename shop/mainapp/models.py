...
class Customer(models.Model):
    ...
    orders = models.ManyToManyField('Order', blank=True, verbose_name='Заказы покупателя',
...
class Order(models.Model):
    ...
    address = models.CharField(max_length=1025, verbose_name='Адрес', null=True, blank=True)
    ...
    order_date = models.DateField(verbose_name='Дата получения закаа', default=timezone.now)
